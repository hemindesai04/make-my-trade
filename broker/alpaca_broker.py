...
class AlpacaBroker(BrokerBase):
    ...
    def place_order(self, symbol: str, qty: int, side: str, price: str, type: str = "market", time_in_force: str = "gtc"):
        order = self.client.submit_order(
            symbol=symbol, qty=qty, side=side, type=type, price=price, time_in_force=time_in_force
        )
