...
class DataFetcherBase(ABC):
    @abstractmethod
    def get_historical_crypto_data(self, start: datetime, end: datetime, ticker: CryptoTicker, **kwargs) -> pd.DataFrame:
        pass

    @abstractmethod
    def get_historical_stocks_data(self, start: datetime, end: datetime, ticker: str, **kwargs) -> pd.DataFrame:
        raise NotImplementedError("Stock data fetching not implemented for this fetcher.")
